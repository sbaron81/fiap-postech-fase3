...
def update_flag(name):
    ...
    # nosec B608 -- 'fields' so contem fragmentos fixos ("description = %s",
    # "is_enabled = %s") escolhidos por whitelist acima, nunca nomes de coluna
    # vindos do usuario; os valores em si sao parametrizados via %s abaixo.
